...
export default function Cities(){
  ...
  return <main><Header city={coreCities[0]}/><div className="page-shell internal-visual internal-cities">
    ...
    <p className="page-subtitle">Choose any supported city to get local sunrise, sunset, Rahu Kalam, Yamaganda, Gulika and auspicious timings calculated for that location. Search engines are intentionally allowed to index only a smaller demand-backed subset while the full directory remains available to users.</p>
